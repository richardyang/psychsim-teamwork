...
class Scenario:
    ...
    def create_base(self):
        ...
        self.world.setDynamics(stateKey('Distractor0', 'deployed'), action, tree)
        ...
        base.setReward(minimizeDifference(stateKey('Distractor0', 'x'), stateKey('Enemy0', 'x')), self.BASE[0])
        base.setReward(minimizeDifference(stateKey('Distractor0', 'y'), stateKey('Enemy0', 'y')), self.BASE[0])
        base.setReward(minimizeFeature(stateKey('Distractor0', 'cost')), self.BASE[1])
